"""
ciclo_docentes.py — ¿La caída se concentra en algún ciclo?
...
SALIDA
  ...
  - CSV: data/processed/metricas/ciclo_docentes.csv
"""
...
# Con ~150k docentes, por debajo de 200 el % es puro ruido muestral.
MIN_N = 200
